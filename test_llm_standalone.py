...
async def test_entity_extraction_service():
    ...
    try:
        ...
        entity_extraction_service = LLMEntityExtractionService(mock_llm_service, str(prompts_dir))
        ...
        result = await entity_extraction_service.extract_entities("John met Sarah", thought_id)
