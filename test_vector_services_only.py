...
def test_vector_services_directly():
    ...
    with patch("src.infrastructure.services.embedding_service.AsyncOpenAI") as mock_openai, \
         ...
         patch("src.infrastructure.services.vector_store_service.pinecone.Index") as mock_index:
