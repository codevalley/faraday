...
class APIClient:
    ...
    async def create_thought(self, content: str, metadata: Optional[Dict] = None) -> ThoughtData:
    ...
    async def search_thoughts(self, query: str, limit: int = 20, 
    ...
    async def get_thoughts(self, limit: int = 20, offset: int = 0, 
                          filters: Optional[Dict] = None) -> List[ThoughtData]:
