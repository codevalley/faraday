...
def main():
    ...
    if passed == total:
        ...
        print("  • src/faraday_cli/commands/help.py - Help command system")
        print("  • src/faraday_cli/main.py - Enhanced main help")
        print("  • src/faraday_cli/interactive.py - Enhanced interactive help")
        print("  • docs/faraday.1 - Man page")
